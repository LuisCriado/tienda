  ...
  return (
    <Form onSubmit={formik.handleSubmit}>
        <Form.Group widths="equal">
          ...
          <Form.Input name="username" type="text" placeholder="Nombre del Usuario" value={formik.values.username} onChange={formik.handleChange} error={formik.errors.username} />
          </Form.Group>
